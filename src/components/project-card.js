...
const cards = [
    ...
    },
    {
        ...
        paragraph: 'The GIS Tax Mapping Web App is a cloned frontend of a previous tax mapping project designed for local government use. Built with React and Leaflet, it features an interactive map for exploring tax-related data like property boundaries and assessments, offering a user-friendly way to visualize and analyze geographic tax information.',
    }
];
